module OS.SessionManager.WindowManager.View exposing (renderWindow)
...
renderWindow : WindowID -> GameModel -> Model -> Html Msg
renderWindow id game model =
    div [] []
...
--         ]
--         [ div [] [] -- Html.map MsgOS (Html.map MsgWM (header id window))
--         , div
